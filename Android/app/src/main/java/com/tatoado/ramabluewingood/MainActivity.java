...
public class MainActivity extends Activity {
    ...
    Button btnOn, btnOff;
    TextView txtArduino, txtString, txtStringLength,  sensorView1, sensorView2;
            ...
            public void handleMessage(android.os.Message msg) {
                if (msg.what == handlerState) {										//if message is what we want
                    ...
                    if (endOfLineIndex > 0) {                                           // make sure there data before ~
                        ...
                        String nuevo = dataInPrint.toString();
                        if (nuevo.equals("#11"))
                        {
                            sensorView1.setText("Se registro Un Movimiento");
                           // Toast.makeText(getBaseContext(), recDataString, Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            sensorView1.setText("Sin Movimientos");
                        }
                    ...
                    //        sensorView0.setText("Encendido");	//update the textviews with sensor values
                           ...
                           // sensorView1.setText(recDataString);
                            sensorView2.setText(recDataString);
                           // Toast.makeText(getBaseContext(), recDataString+"afuera", Toast.LENGTH_SHORT).show();
